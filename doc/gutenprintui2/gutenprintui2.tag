...
<tagfile doxygen_version="1.10.0" doxygen_gitid="GIT-NOTFOUND">
  <compound kind="file">
    <name>curve.h</name>
    <path>include/gutenprintui2/</path>
  ...
  <compound kind="file">
    ...
    <includes id="curve_8h" name="curve.h" local="no" import="no" module="no" objc="no">gutenprintui2/curve.h</includes>
    <includes id="gammacurve_8h" name="gammacurve.h" local="no" import="no" module="no" objc="no">gutenprintui2/gammacurve.h</includes>
    <includes id="typebuiltins_8h" name="typebuiltins.h" local="no" import="no" module="no" objc="no">gutenprintui2/typebuiltins.h</includes>
