...
static const stp_parameter_t the_parameters[] =
{
  ...
  {
    "VioletHueCurve", N_("Violet Map"), "Color=Yes,Category=Advanced Output Control",
    N_("Adjust the violet map"),
    STP_PARAMETER_TYPE_CURVE, STP_PARAMETER_CLASS_OUTPUT,
    STP_PARAMETER_LEVEL_ADVANCED4, 0, 1, 5, 1, 0
  },
...
static const float_param_t float_parameters[] =
{
  ...
  {
    {
      "VioletDensity", N_("Violet Density"), "Color=Yes,Category=Output Level Adjustment",
      N_("Adjust the violet density"),
      STP_PARAMETER_TYPE_DOUBLE, STP_PARAMETER_CLASS_OUTPUT,
      STP_PARAMETER_LEVEL_ADVANCED, 0, 1, 5, 1, 0
    }, 0.0, 2.0, 1.0, 1
  },
  ...
  if (input_image_type && strcmp(input_image_type, "Raw") == 0)
      ...
      if (ink_type)
	{
	  switch (ink_type->inkset)
	    ...
	    case INKSET_CMYK:
	    case INKSET_CMY:
	    case INKSET_CcMmYVKk:
	    case INKSET_CcMmYVOGKk:
	    case INKSET_OTHER:
