	     ...
	     inklist_t *ikl)
{
  ...
  if (name)
    {
      if (!strcmp(name, "CcMmYKk"))
	inl->inkset = INKSET_CcMmYKk;
      else if (!strcmp(name, "CcMmYK"))
	inl->inkset = INKSET_CcMmYK;
      else if (!strcmp(name, "CcMmYK"))
	inl->inkset = INKSET_CcMmY;
      else if (!strcmp(name, "CMYK"))
	inl->inkset = INKSET_CMYK;
      else if (!strcmp(name, "CMY"))
	inl->inkset = INKSET_CMY;
      else if (!strcmp(name, "CcMmYVKk"))
	inl->inkset = INKSET_CcMmYVKk;
      else if (!strcmp(name, "CcMmYVOGKk"))
	inl->inkset = INKSET_CcMmYVOGKk;
